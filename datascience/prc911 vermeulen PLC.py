...
sInputFileName = 'C:/Users/Medhansh/Downloads/Assess-Network-Routing-Customer.csv'
...
if os.path.isabs(sInputFileName):
...
sFileOut1 = os.path.join(Base, Company, sOutputFileName1)
print('################################')
print('Storing :', sFileOut1)
print('################################')

os.makedirs(os.path.dirname(sFileOut1), exist_ok=True)
nx.write_gml(G, sFileOut1)


sFileOut2 = os.path.join(Base, Company, sOutputFileName2)
print('################################')
print('Storing Graph Image:', sFileOut2)
print('################################')
...
os.makedirs(os.path.dirname(sFileOut2), exist_ok=True)
plt.savefig(sFileOut2, dpi=600)
plt.show()
